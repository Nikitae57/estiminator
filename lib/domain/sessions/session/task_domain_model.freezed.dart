...
class _$_TaskDomainModel implements _TaskDomainModel {
  ...
  @override
  String toString() {
    return 'TaskDomainModel(title: $title, description: $description, finalEstimation: $finalEstimation, jiraLink: $jiraLink, estimations: $estimations)';
  }
