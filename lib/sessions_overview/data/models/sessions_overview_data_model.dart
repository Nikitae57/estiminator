import 'package:estiminator/sessions_overview/data/models/session_overview_data_model.dart';
...
class SessionsOverviewDataModel with _$SessionsOverviewDataModel {
  ...
  factory SessionsOverviewDataModel.fromJson(Map<String, dynamic> map) => _$SessionsOverviewDataModelFromJson(map);
}
